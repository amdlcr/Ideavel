...
<div class="flex items-center space-x-8">
    ...
    <!-- Like -->
     ...
     Para que lo mantenga o no aunque el usuario navegue por la pagina -->
        ...
        <button type="button" name="botonLike" value="like" class="btn_like {{ auth()->user()->ideasLiked->contains($idea->id) ? 'liked_color' : '' }}" data-id="{{ $idea->id }}" >
    ...
    <!-- Con la clase comprobamos si la idea ya ha sido "dislike" por el usuario logado y si es asi que mantenga su color, si no nada. 
     Para que lo mantenga o no aunque el usuario navegue por la pagina -->
        ...
        <button type="button" name="botonLike" value="dislike" class="btn_like {{ auth()->user()->ideasDisliked->contains($idea->id) ? 'disliked_color' : '' }}" data-id="{{ $idea->id }}">
